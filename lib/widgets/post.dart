...
import 'package:bugdad/pages/comments.dart';
    ...
    return showDialog(
        ...
        builder: (context) {
          return SimpleDialog(
            ...
            title: Text("Remove this post..?",style: TextStyle(fontFamily: "ITCKRIST",fontWeight: FontWeight.bold,fontSize: 25.0),),
            children: <Widget>[
              SimpleDialogOption(
                  onPressed: () {
                  ...
                  child: Text(
                    'Delete',
                    style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontFamily: "ITCKRIST"),
                  )),
              SimpleDialogOption(
                  onPressed: () => Navigator.pop(context),
                  child: Text('Cancel',style:TextStyle(fontFamily: "ITCKRIST"),)),
            ],
          );
        });
  }
